...
const allProjects = [
  ...
  },
  {
    ...
    longDescription: 'Complete digital solution for restaurant chain featuring online ordering system, location finder, menu management, customer reviews, and loyalty program integration. Includes admin dashboard for multi-location management.',
    image: '/api/placeholder/800/600',
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight">
              Our Complete
              <br />
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {categories.map((category) => (
                <button
                  ...
                  className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 rounded-lg transition-all duration-300 text-xs sm:text-sm ${
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/10 overflow-hidden hover:border-purple-400/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10">
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3 group-hover:text-purple-300 transition-colors leading-tight">
                      {project.title}
                    </h3>
        ...
        >
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 border border-white/10 max-w-4xl mx-auto">
            <Zap className="w-8 h-8 sm:w-10 h-10 md:w-12 h-12 text-purple-400 mx-auto mb-4 sm:mb-6" />
            ...
            <Link
              href="/#contact"
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-lg sm:rounded-xl transition-all duration-300 hover:shadow-lg text-sm sm:text-base"
            >
              Start Your Project
              <ExternalLink className="w-4 h-4 sm:w-5 h-5" />
            </Link>
